...
namespace Checkpoints
{
    ...
    // cticoin: synchronized checkpoint (centrally broadcasted)
    ...
    // cticoin: get last synchronized checkpoint
    ...
    // cticoin: only descendant of current sync-checkpoint is allowed
    ...
    // cticoin: reset synchronized checkpoint to last hardened checkpoint
...
// cticoin: sync-checkpoint master key
...
// cticoin: verify signature of sync-checkpoint message
...
// cticoin: process synchronized checkpoint
