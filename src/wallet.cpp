...
bool CWallet::SetMinVersion(enum WalletFeature nVersion, CWalletDB* pwalletdbIn, bool fExplicti)
{
    ...
    if (fExplicti && nVersion > nWalletMaxVersion)
...
// cticoin: total coins staked (non-spendable until maturity)
...
// cticoin: get current stake weight
...
// cticoin: check 'spent' consistency between wallet and txindex
// cticoin: fix wallet spent state according to txindex
...
// cticoin: disable transaction (only for coinstake)
